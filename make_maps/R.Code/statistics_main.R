...
setwd("C:/Users/tunc_oz/desktop/apply_model/")
...
source('./accuracy_assessment_make_maps/R.Code/extract.overall.acc_Function.R')
input <- list.files("./accuracy_assessment_make_maps/results_1/new","Matrix.*.RData",recursive = T,full.names = T)
...
source('C:/Users/tunc_oz/desktop/apply_model/accuracy_assessment_make_maps/R.Code/prepare.overall.statistics_Function.R')
...
source('C:/Users/tunc_oz/desktop/apply_model/accuracy_assessment_make_maps/R.Code/extract.class.F1ACC_Function.R')
input.mul <- list.files("./accuracy_assessment_make_maps/results_1/new","Multi.*Matrix.*.RData",recursive = T,full.names = T)
result2 <- extract.accandF1(input.mul[4],percent=T)

# calculate the sd and mean
source('C:/Users/tunc_oz/desktop/apply_model/accuracy_assessment_make_maps/R.Code/prepare.class.statistics_Function.R')
...
source('C:/Users/tunc_oz/desktop/apply_model/accuracy_assessment_make_maps/R.Code/format.output_Function.R')
