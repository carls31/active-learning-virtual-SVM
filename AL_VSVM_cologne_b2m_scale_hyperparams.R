...
resampledSize = c(b,2*b)        # total number of relabeld samples # b, b*2, b*6
newSizes = c(2,4)           # number of samples picked in each Active Learning iteration # 4, 5, 10, 20, resampledSize
