...
if(length(sampleSizePor)>=8){
  ...
  if(num_cores>4){
    ...
    cat(best_bound_oa_SL, best_boundMargine_oa_SL, best_bound_oa_SL_Un, best_boundMargine_oa_SL_Un, best_bound_oa_SL_vUn, best_boundMargine_oa_SL_vUn, best_model_oa, 
