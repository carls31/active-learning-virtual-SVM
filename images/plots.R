...
lines(x, ExCsvMSD(AccuracySVM_SL_Un_b)[1,], type="l" ,   col = 1, lwd = 2,lty = 4)

lines(x, ExCsvMSD(AccuracyVSVM)[1,], type="l" ,          col = 3, lwd = 2,lty = 1)
lines(x, ExCsvMSD(AccuracyVSVM_SL)[1,], type="l" ,       col = 3, lwd = 2,lty = 2)
lines(x, ExCsvMSD(AccuracyVSVM_SL_Un_b)[1,], type="l" ,  col = 4, lwd = 2,lty = 1)
lines(x, ExCsvMSD(AccuracyVSVM_SL_vUn_b)[1,], type="l" , col = 5, lwd = 2,lty = 1)
...
lines(x, avgSVM_SL_Un_b, type="l" ,   col = 1, lwd = 2,lty = 4)

lines(x, avgVSVM, type="l" ,          col = 3, lwd = 2,lty = 1)
lines(x, avgVSVM_SL, type="l" ,       col = 3, lwd = 2,lty = 2)
lines(x, avgVSVM_SL_Un_b, type="l" ,  col = 4, lwd = 2,lty = 1)
lines(x, avgVSVM_SL_vUn_b, type="l" , col = 5, lwd = 2,lty = 1)

# lines(x, AccuracyVSVM_SL_Un_b_mclp, type="l" , col = 4, lwd=2,lty=2)
# lines(x, AccuracyVSVM_SL_Un_b_mclu, type="l" , col = 5, lwd=2)
# lines(x, AccuracyVSVM_SL_Un_b_ms, type="l" , col = 6, lwd=2)
 
lines(x, avgVSVM_SL_Un_it, type="l" , col = 7, lwd = 2, lty = 1)
...
lines(x, ExCsvMSD(KappaSVM_SL_Un_b)[1,], type="l" ,   col = 1, lwd=2,lty = 4)

lines(x, ExCsvMSD(KappaVSVM)[1,], type="l" ,          col = 3, lwd=2,lty = 1)
lines(x, ExCsvMSD(KappaVSVM_SL)[1,], type="l" ,       col = 3, lwd=2,lty = 2)
lines(x, ExCsvMSD(KappaVSVM_SL_Un_b)[1,], type="l" ,  col = 4, lwd=2,lty = 1)
lines(x, ExCsvMSD(KappaVSVM_SL_vUn_b)[1,], type="l" , col = 5, lwd=2,lty = 1)

lines(x, ExCsvMSD(KappaVSVM_SL_Un_it)[1,], type="l" , col = 7, lwd=2,lty = 1)
