...
sampleSizePor = c(85,100, 100) # only one sample size for plotting the thematc map
...
num_cores <- parallel::detectCores()-1 # 54 # 48 # Numbers of CPU cores for parallel processing
